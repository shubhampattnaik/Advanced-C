...
/* Close encode files */
void close_files_encode(EncodeInfo *encInfo);		//done
...
/* Copy bmp image header */				//done
Status copy_bmp_header(FILE * fptr_src_image, FILE *fptr_dest_image);

/* Store Magic String */				//done
Status encode_magic_string(const char *magic_string, EncodeInfo *encInfo);

/* Encode secret file extenstion */			//done
Status encode_secret_file_extn(const char *file_extn, EncodeInfo *encInfo);

/* Encode secret file size */				//done
Status encode_secret_file_size(long file_size, EncodeInfo *encInfo);

/* Encode secret file data*/				//done
Status encode_secret_file_data(EncodeInfo *encInfo);

/* Encode function, which does the real encoding */
Status encode_data_to_image(char *data, int size, FILE *fptr_src_image, FILE *fptr_stego_image);

/* Encode a byte into LSB of image data array */	//done
